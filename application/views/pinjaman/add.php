            ...
            <div class="panel-body">
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input class="form-control" type="text" disabled="disabled" value="auto">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <input id="bunga" name="bunga" class="form-control angka" type="text" placeholder="0.00" maxlength="20" onkeypress="return blockNonNumbers(this, event, true, false);">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <button class="btn btn-success btn-outlined" type="submit"> Simpan</button>
                            </div>
